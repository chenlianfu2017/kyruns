		...
		<div class="col-md-5" style="background-color:rgb(255,255,255);margin-right:30px;">
			<form role="form" style="padding-top:15px;" action="do_tj_propertyRight.php" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<div class="form-group col-lg-8 col-md-8 col-sm-8">
				  <label for="name" class="fontTitle">部门（<span class="fontStar">※</span>必填）</label>
				  <p class="help-block">信息科学与工程学院</p>
			    ...
			    <div class="form-group col-lg-8 col-md-8 col-sm-8">
				  ...
				  <input type="text" class="form-control input-sm" id="name3" placeholder="" name="idcard">
			    </div>
			    <div class="form-group col-lg-8 col-md-8 col-sm-8">
				  <label for="name" class="fontTitle">工资卡号（可先不填）</label>
				  <input type="text" class="form-control input-sm" id="name4" placeholder="" name="paycard">
			    </div>
				<div class="form-group col-lg-8 col-md-8 col-sm-8">
				  <label for="name" class="fontTitle">成果或专利名称<span class="fontStar">&nbsp;※</span></label>
				  <input type="text" class="form-control input-sm" id="name4" placeholder="" name="cname">
			    </div>
				...
				<div class="col-lg-8 col-md-8 col-sm-8" style="padding-top:15px;">
