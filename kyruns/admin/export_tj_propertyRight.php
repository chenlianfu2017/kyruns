	...
	<table class="table table-bordered">
		...
		<?php
			...
			if($select_author && $select_date <> ""){
				$sql = "SELECT * FROM `tb_tj_propertyright` WHERE name = '$select_author' AND date = {$select_date}";
			}elseif($select_date == ""){
				if($select_author == "" ){
					$sql = "SELECT * FROM `tb_tj_propertyright`";
				}else{
					$sql = "SELECT * FROM `tb_tj_propertyright` WHERE name = '$select_author'";
				}
			}elseif($select_author == ""){
				if($select_date == "" ){
					$sql = "SELECT * FROM `tb_tj_propertyright`";
				}else{
					$sql = "SELECT * FROM `tb_tj_propertyright` WHERE date = {$select_date}";
				}
			}
