	        ...
	        <div class="form-group col-md-12" style="padding: 0 15px 0;">
	            <div class="row">
		           <span class="col-md-3">
					   ...
					   <input type="text" name="cmanname" autocomplete="off" value="<?php echo $_GET['cmanname'];?>" style="background-color:#FFFFFF; height:30px; padding: 5px 10px;font-size:12px;line-height:2;border:1px solid #ccc;border-radius:3px; width:70%;">
				   </span>							
		           <span class="col-md-3">
		           <label for="name">年份</label>
                     <select class="input-sm" id="year1" name="ctime" style="width:70%;border:1px solid #ccc;">
