...
if($select_year == ""){
	if($type == ""){
		$sql="SELECT * FROM tb_cost WHERE uid = {$_SESSION['uid']}";
	}else{
		$sql="SELECT * FROM tb_cost WHERE uid = {$_SESSION['uid']} AND ctype = '$type'";
	}
}else{
	if($type == ""){
		$sql="SELECT * FROM tb_cost WHERE uid = {$_SESSION['uid']} AND ctime = '$select_year'";
	}else{
		$sql="SELECT * FROM tb_cost WHERE uid = {$_SESSION['uid']} AND ctime = '$select_year' AND ctype = '$type'";
	}
}
